    ...
    def visit_Lambda(
        ...
        def make_temps(
            ...
            if desc.transient:
                ...
                temp_field = gtir_builtin_translators.Field(dst_node, x.data_type, x.local_offset)
                ...
                temp_field = gtir_builtin_translators.Field(data_node, x.data_type, x.local_offset)

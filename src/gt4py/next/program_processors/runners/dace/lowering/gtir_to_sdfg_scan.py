...
def _lower_lambda_to_nested_sdfg(
    ...
    def connect_scan_output(
        ...
        assert scan_result_desc.transient
        ...
        for in_edge in compute_state.in_edges(scan_result.dc_node):
            src_subset = in_edge.data.get_src_subset(in_edge, compute_state)
        ...
        update_state.add_nedge(
            update_state.add_access(output),
